...
<html>
<head>
    <title><?= htmlchars($Settings->get("data.site_name")) ?></title>
</head>
            ...
            <table style="border: none; border-collapse: collapse; width: 100%; table-layout: fixed; font-size: 12px; color: #9b9b9b;">
                <tr>
                    <td style="vertical-align: top; text-align: left;">
                        <a href="<?= APPURL ?>" style="color: #3b7cff; text-decoration: none; font-weight: bold;"><?= htmlchars($Settings->get("data.site_name")) ?></a>
                    </td>
