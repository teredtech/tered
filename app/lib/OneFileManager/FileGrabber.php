...
class FileGrabber
{
    ...
    private function grabFromGoogleDrive()
    {
        ...
        if ($this->manager->getOption("max_file_size") && 
            ...
            $this->manager->getOption("max_file_size") < $filesize)
        {
        ...
        if ($this->manager->getOption("max_storage_size") && 
            ...
            $this->manager->getOption("max_storage_size") < $this->console->getUsedStorageSize() + $filesize)
        {
            return Common::error("There is not enough storage to upload this file");
        }
    ...
    private function grabFromUrl()
    {
        ...
        if (!$ext) {
            return Common::error(__("Couldn't detect file extension!"));
        }
