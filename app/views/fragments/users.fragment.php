            ...
            <div class="clearfix">
                <aside class="skeleton-aside">
                    ...
                    <div class="aside-list js-loadmore-content" data-loadmore-id="1">
                        <?php if ($Users->getPage() == 1): ?>
                            <div class="aside-list-item js-list-item <?= $active_item_id == $AuthUser->get("id") ? "active" : "" ?>">
                                <div class="clearfix">
                                    <?php $title = htmlchars($AuthUser->get("firstname")." ".$AuthUser->get("lastname")); ?>
                                    <span class="circle">
                                    ...
                                    <div class="inner">
                                        ...
                                        <div class="sub"><?= __("Your account") ?></div>

                                        <?php if ($AuthUser->get("expire_date") < "2050"): ?>
                                            <div class="meta">
                                                <span>
                                                    <?php 
                                        ...
                                        <div class="meta">
                                            ...
                                            <?php $pack = Controller::model("Package", $AuthUser->get("package_id")); ?>
                                            <?php if ($pack->isAvailable()): ?>
                                                <span>
                                                    <span class="mdi mdi-package-variant"></span>
                                                    <?= htmlchars($pack->get("title")) ?>
                                                </span>
                                            <?php endif ?>
                                        </div>
                                    </div>

                                    <a class="full-link js-ajaxload-content" href="<?= APPURL."/users/".$AuthUser->get("id") ?>"></a>
                                </div>
                            </div>
                        <?php endif ?>
